...
gulp.task('lcopy', function () {
	return src([project_folder + '/**/*'])
		.pipe(dest('E:/openserver/OpenServer/domains/localhost/название_папки'));
});
...
let build = gulp.series(clean, gulp.parallel(originalcss, js, css, html, images, fonts, favicon, mailer), fontsStyle);
